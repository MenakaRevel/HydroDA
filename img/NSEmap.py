...
#--
cbar=m.colorbar(im,"right",size="2%",ticks=np.arange(vmin,vmax+0.001,0.2),extend="min")
cbar.set_label("NSE")
#plt.title(stitle)
plt.savefig(assim_out+"/figures/NSEAI/NSEAIassim_map.png",dpi=500,bbox_inches="tight", pad_inches=0.05)
